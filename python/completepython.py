...
# ⦁ Python indentation tells the interpreter that a group of statements is related to a specific block or cell of code.

# Comments In Python:
# ⦁ Comments in Python or any other programming language are just for a better understanding and better readability of code. Whenever an interpreter encounters a comment in the program, it simply skips it and moves to the next line of code. 

# ⦁ Developers make use of comments because, without comments, things can get really confusing. It would be impossible to know the function of code in a massive program. 

# ⦁ Comments help the developers to explain the logic used in a line of code. 
