...
#   Designing the tic tac toe in 3X3 grid gameboard.
...
#using the while loop to call the  tictactoe_grid function whenever it remains TRUE.
        ...
        try: 
            print("The player ", player_current, " turn. Now you need to choose your block using press nmbr 1 to 9 : ", end="") 
            chance = int(input()) 
        except ValueError: 
...
# Menu displayed to the players
        print(player_current,", you get the chance to start the Tic tac toe game:") 
